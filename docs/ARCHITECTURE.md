...
**المشرف ومديرَ المعهد والمشرفَ الأعلى والمبرمج معاً، بما تحتويه اللوحة كاملاً**
([APPS-FEATURES.md §4](APPS-FEATURES.md))، فلم يعد «الاتّكاء على أن المشرف أستاذٌ أيضاً» طريقاً
مقبولاً: ربطُ حسابات الأربعة بمعهدٍ هو **البندُ الأول في م.6** ([CLIENTS.md §5](CLIENTS.md) البند 2).

وأثرٌ ثانٍ أثقل: **سطحُ الإدارة كلُّه بلا نقطة API** — المعاهدُ والمستخدمون والأدوارُ وبياناتُ
الدخول تُكتب من اللوحة عبر `app/Actions/` مباشرةً ([CLIENTS.md §2](CLIENTS.md)). فالجدولُ أعلاه
يصف **سطحين**، وقرارُ 2026-09-07 يوجب أن يصير للسطح الثاني ما للأول من أبواب. وحتى ذلك الحين
يبقى الوصفُ أعلاه واقعَ الكود.
