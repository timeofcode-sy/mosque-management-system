...
> **حالة الخطة:** محدّثة بعد تنفيذ المراحل 0 إلى **7.3** — **المرحلتان 5 و6 مكتملتان**: تطبيقُ
...
> (7.1) ومستودعُها في `mousqe_core` (7.2) **وتطبيقُها قائمٌ عاملاً** (7.3)، ولم يبقَ منها إلا الإشعارُ الفوري (7.4 — معلَّقةٌ على حساب Firebase).
