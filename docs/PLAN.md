...
> **حالة الخطة:** محدّثة بعد تنفيذ المراحل 0 إلى **7.4** — **المرحلتان 5 و6 مكتملتان**: تطبيقُ
...
| 7.4 | **الإشعارُ الفوري** | `PushNotifier` بتنفيذَين · إشعارٌ عند إغلاق الجلسة وعند البتّ في الإذن · تمريرُ التوكن عبر `/devices/register` القائمة | يوم | 🔄 **الخادمُ منفَّذ** — 417 اختباراً · ويبقى `flutterfire configure` وحده — [CHECKPOINT-PHASE-7.4.MD](CHECKPOINT-PHASE-7.4.MD) |
...
php artisan test --compact                # 407 حالياً (405 تمرّ + 2 متجاوَزان)
