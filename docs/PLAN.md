...
> **حالة الخطة:** محدّثة بعد تنفيذ المراحل 0 إلى 4.7.
...
> و[CHECKPOINT-PHASE-4.7.MD](CHECKPOINT-PHASE-4.7.MD).
>
...
| 5 | **تطبيق الأستاذ** | Flutter أوف-لاين كامل + `mousqe_core` + `mousqe_ui` | ٨–١٠ أيام | ⬜ التالية — تسبقها فجوتان حاجبتان، [CLIENTS.md §5](CLIENTS.md) |
