...
| 7.4 | **الإشعارُ الفوري** | `PushNotifier` بتنفيذَين · إشعارٌ عند إغلاق الجلسة وعند البتّ في الإذن · تمريرُ التوكن عبر `/devices/register` القائمة · وربطُ مشروع `mousqe` | يوم | ✅ **منفَّذة** — 417 خادمياً · 212 في Dart · وبناءُ APK بـFirebase مُجرَّب — [CHECKPOINT-PHASE-7.4.MD](CHECKPOINT-PHASE-7.4.MD) |
